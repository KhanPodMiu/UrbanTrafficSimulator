...
int main(int argc, char* argv[]) {
   ...
   const std::filesystem::path mapFilePath = resolveAssetPath("assets/maps/khapkhap.json");
    ...
    while(is_game_running){
        ...
        //just separated it again, dont merge them toghether plssss!!!!
        EventManager::processEvents(appContext, clock, statisticsPanel, entityInfoPanel, vehicleManager, camera, visualizationEngine);
